...
const DifficultyPage = () => {
  ...
  const handleDifficultyClick = (difficulty) => {
    ...
    switch (difficulty) {
      case 'easy':
        router.push(`/number-topics`); // Navigate to Color Matching page
        break;
      case 'normal':
        router.push(`/number-topics`); // Navigate to Color Guess page
        break;
      case 'hard':
        router.push(`/number-topics`); // Navigate to Trace the Color page
        break;
      default:
